...
const Questionnaire = ({ userData, onComplete }) => {
  ...
  }, [userData, navigate, isNavigating]);
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Auto-login: Save credentials to localStorage
      ...
      setIsNavigating(true); // Prevent redirect before navigation
      ...
      setError(err.message || 'Error al procesar el registro. Por favor intenta de nuevo.');
